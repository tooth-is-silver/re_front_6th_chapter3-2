...
>(({ className, children, size = 'medium', ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex w-full items-center justify-between rounded-md border border-gray-300 bg-white ring-offset-background placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
        sizeStyles[size],
        className
      )}
      {...props}
...
// Legacy MenuItem component for compatibility
